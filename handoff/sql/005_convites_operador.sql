-- Convites públicos para cadastro de operador vinculado a um GAEP (aba Gestão → Efetivo).
-- Execute no SQL Editor do Supabase (após 001_schema e migrations de operadores).
